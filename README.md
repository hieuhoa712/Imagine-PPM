...
### Commenting
You should
* Add pre and post conditions in the header (see page 139)
...
img.DrawPixel(5, 5);       // Draw a red pixel at the (5, 5)
...
> **Hint:** Use a for loop for x values from 3 to 5.
